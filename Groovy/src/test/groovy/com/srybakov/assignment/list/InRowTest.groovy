 ...
 */
class InRowTest extends GroovyTestCase {
    ...
    public void testCase5(){
        def result = ListUtils.removeDuplicates([1, 2, 2, 2, 1],
                APPEARANCE, IS_DELETE_IN_ROW)
        assert result == [1, 1]
    }
    ...
    public void testCase13(){
        def result = ListUtils.removeDuplicates([1, null, 1, null, null, 1],
                APPEARANCE, IS_DELETE_IN_ROW)
        assert result == [1, null, 1, null, null, 1]
    }


    @Test
    public void testCase14(){
        def result = ListUtils.removeDuplicates([1, null, 2, null, null, null, 1, null, null],
                APPEARANCE, IS_DELETE_IN_ROW)
        assert result == [1, null, 2, 1, null, null]
    }
}
